...
export const PrimaryCancerConditionsDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PrimaryCancerConditionsDtoScaffold = z.infer<typeof PrimaryCancerConditionsDtoScaffoldSchema>;
