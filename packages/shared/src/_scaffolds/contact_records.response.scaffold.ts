...
export const ContactRecordsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ContactRecordsResponseScaffold = z.infer<typeof ContactRecordsResponseScaffoldSchema>;
