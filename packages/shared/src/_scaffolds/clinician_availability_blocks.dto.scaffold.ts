...
export const ClinicianAvailabilityBlocksDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ClinicianAvailabilityBlocksDtoScaffold = z.infer<typeof ClinicianAvailabilityBlocksDtoScaffoldSchema>;
