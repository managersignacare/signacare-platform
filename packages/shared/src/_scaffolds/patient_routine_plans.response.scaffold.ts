...
export const PatientRoutinePlansResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientRoutinePlansResponseScaffold = z.infer<typeof PatientRoutinePlansResponseScaffoldSchema>;
