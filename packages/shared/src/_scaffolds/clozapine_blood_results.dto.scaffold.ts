...
export const ClozapineBloodResultsDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ClozapineBloodResultsDtoScaffold = z.infer<typeof ClozapineBloodResultsDtoScaffoldSchema>;
