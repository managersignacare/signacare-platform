...
export const ExternalCalendarSubscriptionsDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ExternalCalendarSubscriptionsDtoScaffold = z.infer<typeof ExternalCalendarSubscriptionsDtoScaffoldSchema>;
