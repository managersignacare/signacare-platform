...
export const MedicationAdministrationsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type MedicationAdministrationsResponseScaffold = z.infer<typeof MedicationAdministrationsResponseScaffoldSchema>;
