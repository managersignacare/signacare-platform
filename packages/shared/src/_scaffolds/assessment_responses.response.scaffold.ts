...
export const AssessmentResponsesResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type AssessmentResponsesResponseScaffold = z.infer<typeof AssessmentResponsesResponseScaffoldSchema>;
