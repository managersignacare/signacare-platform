...
export const ClozapineRegistrationsDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ClozapineRegistrationsDtoScaffold = z.infer<typeof ClozapineRegistrationsDtoScaffoldSchema>;
