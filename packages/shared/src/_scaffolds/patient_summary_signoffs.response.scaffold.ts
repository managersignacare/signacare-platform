...
export const PatientSummarySignoffsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientSummarySignoffsResponseScaffold = z.infer<typeof PatientSummarySignoffsResponseScaffoldSchema>;
