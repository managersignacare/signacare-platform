...
export const PatientTeamAssignmentsDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientTeamAssignmentsDtoScaffold = z.infer<typeof PatientTeamAssignmentsDtoScaffoldSchema>;
