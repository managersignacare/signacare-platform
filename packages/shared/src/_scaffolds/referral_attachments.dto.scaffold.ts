...
export const ReferralAttachmentsDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ReferralAttachmentsDtoScaffold = z.infer<typeof ReferralAttachmentsDtoScaffoldSchema>;
