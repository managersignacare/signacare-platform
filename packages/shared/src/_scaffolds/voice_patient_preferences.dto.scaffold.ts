...
export const VoicePatientPreferencesDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type VoicePatientPreferencesDtoScaffold = z.infer<typeof VoicePatientPreferencesDtoScaffoldSchema>;
