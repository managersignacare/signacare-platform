...
export const PathologyResultsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PathologyResultsResponseScaffold = z.infer<typeof PathologyResultsResponseScaffoldSchema>;
