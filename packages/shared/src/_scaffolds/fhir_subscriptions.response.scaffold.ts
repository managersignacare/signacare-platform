...
export const FhirSubscriptionsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type FhirSubscriptionsResponseScaffold = z.infer<typeof FhirSubscriptionsResponseScaffoldSchema>;
