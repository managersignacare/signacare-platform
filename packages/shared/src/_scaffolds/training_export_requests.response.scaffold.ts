...
export const TrainingExportRequestsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type TrainingExportRequestsResponseScaffold = z.infer<typeof TrainingExportRequestsResponseScaffoldSchema>;
