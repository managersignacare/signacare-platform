...
export const ClinicStepCareRulesDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ClinicStepCareRulesDtoScaffold = z.infer<typeof ClinicStepCareRulesDtoScaffoldSchema>;
