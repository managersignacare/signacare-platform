...
export const PatientDigitalPhenotypesResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientDigitalPhenotypesResponseScaffold = z.infer<typeof PatientDigitalPhenotypesResponseScaffoldSchema>;
