...
export const ClozapineTitrationDaysResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ClozapineTitrationDaysResponseScaffold = z.infer<typeof ClozapineTitrationDaysResponseScaffoldSchema>;
