...
export const AimsAssessmentsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type AimsAssessmentsResponseScaffold = z.infer<typeof AimsAssessmentsResponseScaffoldSchema>;
