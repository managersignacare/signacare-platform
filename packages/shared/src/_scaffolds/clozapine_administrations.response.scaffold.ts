...
export const ClozapineAdministrationsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ClozapineAdministrationsResponseScaffold = z.infer<typeof ClozapineAdministrationsResponseScaffoldSchema>;
