...
export const PatientBehaviorContractsDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientBehaviorContractsDtoScaffold = z.infer<typeof PatientBehaviorContractsDtoScaffoldSchema>;
