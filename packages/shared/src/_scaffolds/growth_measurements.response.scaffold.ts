...
export const GrowthMeasurementsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type GrowthMeasurementsResponseScaffold = z.infer<typeof GrowthMeasurementsResponseScaffoldSchema>;
