...
export const WebhookAuditLogResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type WebhookAuditLogResponseScaffold = z.infer<typeof WebhookAuditLogResponseScaffoldSchema>;
