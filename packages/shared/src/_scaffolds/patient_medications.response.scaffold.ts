...
export const PatientMedicationsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientMedicationsResponseScaffold = z.infer<typeof PatientMedicationsResponseScaffoldSchema>;
