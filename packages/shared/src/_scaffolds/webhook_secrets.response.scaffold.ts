...
export const WebhookSecretsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type WebhookSecretsResponseScaffold = z.infer<typeof WebhookSecretsResponseScaffoldSchema>;
