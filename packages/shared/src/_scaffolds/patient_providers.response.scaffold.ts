...
export const PatientProvidersResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientProvidersResponseScaffold = z.infer<typeof PatientProvidersResponseScaffoldSchema>;
