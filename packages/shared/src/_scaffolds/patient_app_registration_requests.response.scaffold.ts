...
export const PatientAppRegistrationRequestsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientAppRegistrationRequestsResponseScaffold = z.infer<typeof PatientAppRegistrationRequestsResponseScaffoldSchema>;
