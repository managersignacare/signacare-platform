...
export const PatientOutreachLogResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientOutreachLogResponseScaffold = z.infer<typeof PatientOutreachLogResponseScaffoldSchema>;
