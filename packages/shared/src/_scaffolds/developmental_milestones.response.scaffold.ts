...
export const DevelopmentalMilestonesResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type DevelopmentalMilestonesResponseScaffold = z.infer<typeof DevelopmentalMilestonesResponseScaffoldSchema>;
