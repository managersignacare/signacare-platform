...
export const OauthAuthorizationCodesResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type OauthAuthorizationCodesResponseScaffold = z.infer<typeof OauthAuthorizationCodesResponseScaffoldSchema>;
