...
export const PathologyOrdersResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PathologyOrdersResponseScaffold = z.infer<typeof PathologyOrdersResponseScaffoldSchema>;
