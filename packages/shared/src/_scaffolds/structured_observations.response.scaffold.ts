...
export const StructuredObservationsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type StructuredObservationsResponseScaffold = z.infer<typeof StructuredObservationsResponseScaffoldSchema>;
