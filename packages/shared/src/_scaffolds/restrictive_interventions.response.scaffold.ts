...
export const RestrictiveInterventionsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type RestrictiveInterventionsResponseScaffold = z.infer<typeof RestrictiveInterventionsResponseScaffoldSchema>;
