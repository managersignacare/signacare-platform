...
export const RiskAssessmentsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type RiskAssessmentsResponseScaffold = z.infer<typeof RiskAssessmentsResponseScaffoldSchema>;
