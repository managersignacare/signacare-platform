...
export const ClinicalFormulationsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type ClinicalFormulationsResponseScaffold = z.infer<typeof ClinicalFormulationsResponseScaffoldSchema>;
