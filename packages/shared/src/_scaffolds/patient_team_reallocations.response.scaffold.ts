...
export const PatientTeamReallocationsResponseScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type PatientTeamReallocationsResponseScaffold = z.infer<typeof PatientTeamReallocationsResponseScaffoldSchema>;
