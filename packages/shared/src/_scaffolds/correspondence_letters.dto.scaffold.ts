...
export const CorrespondenceLettersDtoScaffoldSchema = z.object({
  id: z.string().uuid(),
...
export type CorrespondenceLettersDtoScaffold = z.infer<typeof CorrespondenceLettersDtoScaffoldSchema>;
