...
export const ALL_MODULES: Array<{ key: string; label: string; description: string }> = [
  ...
  { key: 'medical-scribe', label: 'AI Scribe (Ambient)', description: 'Voice-to-note transcription, AI documentation' },
  { key: 'ai-agent', label: 'AI Agent', description: 'Clinical AI assistant, decision support' },
  { key: 'agentic-ai-scribe', label: 'Agentic AI Scribe (Next-Gen)', description: 'In-visit draft generation for lab orders, referrals, and follow-up appointments' },
