...
export const SELF_RATED_BUILTIN_RATING_SCALE_DEFINITIONS: readonly BuiltinAssessmentTemplate[] = [
  ...
  buildLikertScale({
    name: 'ASRM (Altman Self-Rating Mania Scale)',
    respondentType: 'self',
    ageGroup: 'Adult',
    focus: 'Mania / hypomania symptoms',
    instruction: 'Please rate how much each statement applied to you during the past week.',
    items: [
      'I felt happier or more cheerful than usual',
      'I felt more self-confident than usual',
      'I needed less sleep than usual',
      'I talked more or felt pressure to keep talking',
      'I was more active / did more things than usual',
    ],
    min: 0,
    max: 4,
    options: [
      'Not at all (0)',
      'Slightly / occasionally (1)',
      'Mildly (2)',
      'Moderately (3)',
      'Severely / almost constantly (4)',
    ],
